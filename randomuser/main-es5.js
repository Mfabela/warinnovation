(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! C:\xampp\htdocs\osiristradingapi\src\main.ts */
      "zUnb");
      /***/
    },
    ...
    function vUh(module, __webpack_exports__, __webpack_require__) {
      ...
      var HomeComponent = /*#__PURE__*/function () {
        function HomeComponent(http) {
          ...
          this.http.get('https://randomuser.me/api').subscribe(function (res) {
            _this.user = res.results[0];
            _this.field = _this.user.name.first + ' ' + _this.user.name.last;
            _this.userimg = _this.user.picture.large;
        ...
        _createClass(HomeComponent, [{
          key: "fieldChange",
          value: function fieldChange(fieldName, subHead) {
          ...
          key: "ngOnInit",
          value: function ngOnInit() {//Luthando API - This Imports RESTAPI Data user.service which will be rendered on the page
    ...
    function ZAI4(module, __webpack_exports__, __webpack_require__) {
      ...
      var swiper_angular__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! swiper/angular */
      "UMfn");
      /* harmony import */
