...
$( document ).ready(function() {
  ...
  var packcompacttext = '<h4>You Get:</h4>\
   <ul>\
    <li>\
  The latest in local and international entertainment, including Mzanzi Magic, Africa Magic Movies, SuperSport 3 & 4, Cartoon Network, and Disney Junior\
       <li> \
...
Catch Up, so you can watch movies, sports highlights, doccies and series that you missed anytime you want\
 ...
 HD viewing\
	...
	$( "#premium" ).click(function() {
		...
		//Display
		$('#hddecoderbutt').attr("style","display:none");
		$('#explorerbutt').attr("style","display:block");
		//Display
	...
	$( "#extra" ).click(function() {
		...
		//Display
		$('#hddecoderbutt').attr("style","display:block");
		$('#explorerbutt').attr("style","display:block");
		//Display
	...
	$( "#family" ).click(function() {
		...
		//Display
		$('#hddecoderbutt').attr("style","display:block");
		$('#explorerbutt').attr("style","display:none");
		//Display
